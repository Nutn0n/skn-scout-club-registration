angular.module('ScoutSelection', []) /*  ng-app */
  ...
  .controller('SelectionContoller', ['$scope', function($scope) {
    ...
    $scope.check = function() {
      ...
      if(  $scope.StudentID == __เลขประจำตัว__  ){
       swal("ยินดีด้วย", "_______ชื่อ______  หมายเลขประจำตัว "+$scope.StudentID+" ได้รับเลือกให้เข้าร่วมเป็นสต๊าฟกิจกรรมลูกเสือ กรุณาติดตามข่าวสารเพิ่มเติมจากชุมนุมลูกเสือ", "success")
     }
      */
